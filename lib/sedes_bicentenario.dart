...
import 'package:fitc/map_bicentenario.dart';
...
class _BicentenarioState extends State<Bicentenario> {
  ...
  final lista_bicen = [
    {"nombre":"1","pic":"assets/images/bicentenario_1.jpg"},
    {"nombre":"2","pic":"assets/images/bicentenario_2.jpg"},
    {"nombre":"3","pic":"assets/images/bicentenario_3.jpg"},
  ];
           ...
           // Image.asset("assets/images/pgoitia.jpg", fit: BoxFit.cover),
            actions: <Widget>[
              new IconButton(
                ...
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=>Bicentenario2()));
                },
              )
            ],
            flexibleSpace: new FlexibleSpaceBar(
              title: Text("Plaza bicentenario"),
              background: Image.asset("assets/images/bicentenario.jpg", fit: BoxFit.cover,),
              centerTitle: true,
            ),
            ...
            delegate: SliverChildBuilderDelegate ( 
              (BuildContext context, int index)
              {
                return Container (
                  ...
                  child: Sede(nombre_sede: lista_bicen[index]["nombre"],
                  imagen_sede: lista_bicen[index]["pic"],),
                );
              },  
              childCount: 3,
            ),
